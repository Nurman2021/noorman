...
export let DATA = {
	...
	summary: `I am a passionate learner eager to collaborate on creative projects ✨ and deep learning 🤖. My expertise spans web development 🕸️, with a strong focus on utilizing JavaScript to manipulate web graphics 🎨. I'm always exploring new technologies to solve real-world problems 💡 and enjoy learning from other for learning journey 👨🏻‍💻.`,
	avatarUrl:
		'https://ik.imagekit.io/nurman/Portofolio/nurman-profile-portofolio.png?updatedAt=1727346483705',
	skills: ['Svelte', 'Sveltekit', 'Javascript', 'Node.js', 'ThreeJs', 'TailwindCss', 'Photoshop'],
	navbar: [
	...
	contact: {
		email: 'nurman.awaluddin@student.unismuh.ac.id',
		tel: '+6285343623495',
		social: {
			GitHub: {
				name: 'GitHub',
	...
	education: [
		{
			school: 'University Muhammadiyah of Makassar',
